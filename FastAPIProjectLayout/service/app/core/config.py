...
class Settings(BaseSettings):
    ...
    def MONGODB_URI(self):
        return f"mongodb://{self.MONGODB_USERNAME}:{self.MONGODB_PASSWORD}@{self.MONGODB_HOST}/{self.MONGODB_DB_NAME}"
...
def load_settings():
    ...
    if settings_.TESTING:
        settings_.MONGODB_DB_NAME = f"test_{settings_.MONGODB_DB_NAME}"
    return settings_
